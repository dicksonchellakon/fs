...
class PHPMailer
{
     ...
     * @type string
     */
    public $From = 'fashionretail172014@yahoo.com';//root@localhost

    /**
     * The From name of the message.
     * @type string
     */
    public $FromName = 'Fashion Shoppee';//Root User
     ...
     * @type string
     */
    public $Host = 'email-smtp.us-east-1.amazonaws.com';//localhost
     ...
     * @type string
     */
    public $Username = 'AKIAIHHNGMXEEGWJTG7Q';

    /**
     * SMTP password.
     * @type string
     */
    public $Password = 'ApO84H4hpYdl10mVIsb/UIYaBr5EAUKV2hZNUF5H/pjO';
