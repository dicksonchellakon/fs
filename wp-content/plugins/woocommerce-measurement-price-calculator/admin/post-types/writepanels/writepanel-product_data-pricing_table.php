...
<table class="widefat wc-calculator-pricing-table">
	...
	<tr>
		...
		<th class="price-per-unit-column">
			...
			<img class="help_tip" data-tip='<?php _e( 'Set the price per unit for the configured range.', WC_Measurement_Price_Calculator::TEXT_DOMAIN ) ?>' src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" height="16" width="16" />
		</th>
		<th class="sale-price-per-unit-column">
			...
			<img class="help_tip" data-tip='<?php _e( 'Set a sale price per unit for the configured range.', WC_Measurement_Price_Calculator::TEXT_DOMAIN ) ?>' src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" height="16" width="16" />
		</th>
	</tr>
	</thead>
	<tbody>
