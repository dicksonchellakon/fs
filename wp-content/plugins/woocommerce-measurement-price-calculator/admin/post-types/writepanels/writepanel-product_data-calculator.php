...
function WC_Price_Calculator_Product_rates_panel_content() {
	global $post, $wc_measurement_price_calculator, $woocommerce_settings;
	...
	$tab_icon = $wc_measurement_price_calculator->plugin_url() . '/assets/product-data-icon.png';
	...
	if ( version_compare( WOOCOMMERCE_VERSION, "2.0.0" ) >= 0 ) {
		...
		$active_style = '#woocommerce-product-data ul.product_data_tabs li.measurement_tab.active a { border-bottom: 1px solid #F8F8F8; }';
	}
	...
	<div id="measurement_product_data" class="panel woocommerce_options_panel">
		<style type="text/css">
			...
			#woocommerce-product-data ul.product_data_tabs li.measurement_tab a { <?php echo $style; ?> }
		...
		// Unfortunately the pricing calculator can't work with WC < 2.0 unless the class-wc-cart.php file is patched to include the third $variation_id parameter in the woocommerce_add_cart_item_data filter
		$class_hide_if_variable = '';
		if ( version_compare( WOOCOMMERCE_VERSION, "2.0.0" ) < 0 && ! WC_Measurement_Price_Calculator::WC_PRE_2_PATCHED ) {
			$class_hide_if_variable = ' hide_if_variable';
		}

		// Hide the pricing inventory configuration option for unsuppored WC installs (WC < 2.0.4)
		if ( version_compare( WOOCOMMERCE_VERSION, "2.0.4" ) >= 0 ) $pricing_inventory_wrapper_class = 'stock_fields';
		else $pricing_inventory_wrapper_class = 'hidden';

		$pricing_weight_wrapper_class = '';
		if ( 'no' === get_option( 'woocommerce_enable_weight', true ) ) $pricing_weight_wrapper_class = 'hidden';
		...
		echo '<div id="dimension_measurements" class="measurement_fields">';
			woocommerce_wp_checkbox( array(
				...
				'wrapper_class' => $class_hide_if_variable,
			...
			echo '<div id="_measurement_dimension_pricing_fields" class="_measurement_pricing_fields' . $class_hide_if_variable . '" style="display:none;">';
				...
				woocommerce_wp_checkbox( array(
					...
					'wrapper_class' => $pricing_inventory_wrapper_class . ' _measurement_pricing_calculator_fields',
		...
		echo '<div id="area_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_area_pricing_fields" class="_measurement_pricing_fields' . $class_hide_if_variable . '" style="display:none;">';
				woocommerce_wp_text_input( array(
		...
		echo '<div id="area-dimension_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_area-dimension_pricing_fields" class="_measurement_pricing_fields' . $class_hide_if_variable . '" style="display:none;">';
				woocommerce_wp_text_input( array(
		...
		echo '<div id="volume_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_volume_pricing_fields" class="_measurement_pricing_fields' . $class_hide_if_variable . '" style="display:none;">';
				woocommerce_wp_text_input( array(
		...
		echo '<div id="volume-dimension_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_volume-dimension_pricing_fields" class="_measurement_pricing_fields' . $class_hide_if_variable . '" style="display:none;">';
				woocommerce_wp_text_input( array(
		...
		echo '<div id="volume-area_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_volume-area_pricing_fields" class="_measurement_pricing_fields' . $class_hide_if_variable . '" style="display:none;">';
				woocommerce_wp_text_input( array(
		...
		echo '<div id="weight_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_weight_pricing_fields" class="_measurement_pricing_fields' . $class_hide_if_variable . '" style="display:none;">';
				woocommerce_wp_text_input( array(
		...
		echo '<div id="wall-dimension_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_wall-dimension_pricing_fields" class="_measurement_pricing_fields' . $class_hide_if_variable . '" style="display:none;">';
				woocommerce_wp_text_input( array(
		...
		require_once( $wc_measurement_price_calculator->plugin_path() . '/admin/post-types/writepanels/writepanel-product_data-pricing_table.php' );
		echo '</div>';
		?>
...
function wc_measurement_price_calculator_process_product_meta_measurement( $post_id, $post ) {
	...
	if ( 'no' == $is_virtual && 'grouped' != $product_type ) {
		...
		if ( 'variable' == $product_type && version_compare( WOOCOMMERCE_VERSION, "2.0.0" ) < 0 && ! WC_Measurement_Price_Calculator::WC_PRE_2_PATCHED ) {
		...
		$settings['dimension']['pricing'] = array(
			'enabled'  => isset( $_POST['_measurement_dimension_pricing'] ) && $_POST['_measurement_dimension_pricing'] && $pricing_allowed ? 'yes' : 'no',
		...
		$settings['area']['pricing'] = array(
			'enabled'  => isset( $_POST['_measurement_area_pricing'] ) && $_POST['_measurement_area_pricing'] && $pricing_allowed ? 'yes' : 'no',
		...
		$settings['area-dimension']['pricing'] = array(
			'enabled'  => isset( $_POST['_measurement_area-dimension_pricing'] ) && $_POST['_measurement_area-dimension_pricing'] && $pricing_allowed ? 'yes' : 'no',
		...
		$settings['volume']['pricing'] = array(
			'enabled'  => isset( $_POST['_measurement_volume_pricing'] ) && $_POST['_measurement_volume_pricing'] && $pricing_allowed ? 'yes' : 'no',
		...
		$settings['volume-dimension']['pricing'] = array(
			'enabled'  => isset( $_POST['_measurement_volume-dimension_pricing'] ) && $_POST['_measurement_volume-dimension_pricing'] && $pricing_allowed ? 'yes' : 'no',
		...
		$settings['volume-area']['pricing'] = array(
			'enabled'  => isset( $_POST['_measurement_volume-area_pricing'] ) && $_POST['_measurement_volume-area_pricing'] && $pricing_allowed ? 'yes' : 'no',
		...
		$settings['weight']['pricing'] = array(
			'enabled'  => isset( $_POST['_measurement_weight_pricing'] ) && $_POST['_measurement_weight_pricing'] && $pricing_allowed ? 'yes' : 'no',
		...
		$settings['wall-dimension']['pricing'] = array(
			'enabled'  => isset( $_POST['_measurement_wall-dimension_pricing'] ) && $_POST['_measurement_wall-dimension_pricing'] && $pricing_allowed ? 'yes' : 'no',
