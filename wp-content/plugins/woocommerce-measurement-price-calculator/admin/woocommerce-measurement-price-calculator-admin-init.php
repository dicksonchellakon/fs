...
function wc_measurement_price_calculator_admin_enqueue_scripts() {
	global $taxnow, $woocommerce, $post, $wc_measurement_price_calculator;
	...
	if ( 'product' == $screen->id ) {
		...
		wp_enqueue_script( 'wc-price-calculator-admin', $wc_measurement_price_calculator->plugin_url() . '/assets/js/admin.js' );
...
add_filter( 'woocommerce_catalog_settings', 'wc_measurement_price_calculator_woocommerce_catalog_settings' );
