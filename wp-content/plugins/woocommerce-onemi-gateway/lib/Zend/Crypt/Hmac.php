 ...
 * @see Zend_Crypt
 */
require_once ABSPATH.'/wp-content/plugins/woocommerce-onemi-gateway/lib/Zend/Crypt.php';
...
class Zend_Crypt_Hmac extends Zend_Crypt
{
    ...
    public static function compute($key, $hash, $data, $output = self::STRING)
    {
        ...
        if (!isset($key) || empty($key)) {
            require_once ABSPATH.'/wp-content/plugins/woocommerce-onemi-gateway/lib/Zend/Crypt/Hmac/Exception.php';
