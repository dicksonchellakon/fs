...
<div class="top-form top-form-minicart pull-right">
	...
	?>
	<h2><?php _e('Shopping Cart','yatheme');?></h2>
	...
	?>
		<a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'yatheme'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>'; _e('item(s)', 'yatheme');?></a>
	<?php 	} 

	if( $header_style == 'style1' ||  $header_style == 'style2' ) { ?>
		<span><?php _e('My Cart','yatheme');?></span>
		<a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'yatheme'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>'?></a>
	<?php }  ?>
    ...
    <div class="product-details"> 
        ...
        <a class="btn-edit" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'yatheme'); ?>"><span></span></a>    
		 ...
		 <span class="price"><?php echo $woocommerce->cart->get_product_subtotal($cart_item['data'], 1); ?></span>		        		        		    		
			...
			<div class="cart-checkout">
			    <div class="price-total">
				   <span class="label-price-total"><?php _e('Total:', 'yatheme'); ?></span>
