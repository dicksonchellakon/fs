...
if (!class_exists('WC_Currency_Converter')) {
	...
	class WC_Currency_Converter {
		...
		public function __construct() {
			...
			// Init settings
			$this->settings = array(
				array( 'name' => __( 'Open Exchange Rate API', 'yatheme' ), 'type' => 'title', 'desc' => '', 'id' => 'product_enquiry' ),
				array(
					'name' => __('App Key', 'yatheme'),
					'desc' 		=> sprintf( __('(optional) If you have an <a href="%s">Open Exchange Rate API app ID</a>, enter it here.', 'yatheme'), 'https://openexchangerates.org/signup' ),
