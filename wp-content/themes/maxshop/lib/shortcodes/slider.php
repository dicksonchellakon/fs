	...
	function ya_slider( $atts, $content = NULL ){
		...
		if($title !='' && $show_navigator == 'true'){
			$output .='<div class="box-recommend-title">
			            <a href="#'.esc_attr( $sl_id ).'" class="left carousel-control" data-slide="prev"><i class="icon-angle-left"></i></a>
						<h3>'.esc_html( $title ).'</h3>
						<a href="#'.esc_attr( $sl_id ).'" class="right carousel-control" data-slide="next"><i class="icon-angle-right"></i></a>
						</div>';
		}elseif($title != '' ){
			$output .='<div class="box-recommend-title">
						<h3>'.esc_html( $title ).'</h3>
			...
			$output .= '<a href="#'.esc_attr( $sl_id ).'" class="left carousel-control" data-slide="prev"><i class="icon-angle-left"></i></a>';
			$output .= '<a href="#'.esc_attr( $sl_id ).'" class="right carousel-control" data-slide="next"><i class="icon-angle-right"></i></a>';
		}
