		...
		<div class="entry clearfix">
			...
			<div class="entry-content">				
             ...
             <div class="entry-meta">
                    <div class="bl_read_more"><a href="<?php the_permalink(); ?>"><i class="icon-chevron-right"></i><?php _e('Read more','yatheme')?></a></div>			 
						...
						<?php if( $format == 'gallery' ) { 
							...
							<div class="entry-thumb">
								<div id="gallery_slider_<?php echo $post->ID; ?>" class="carousel slide gallery-slider" data-interval="0">	
									...
									<a href="#gallery_slider_<?php echo $post->ID; ?>" class="left carousel-control" data-slide="prev"><?php _e( 'Prev', 'yatheme' ) ?></a>
									<a href="#gallery_slider_<?php echo $post->ID; ?>" class="right carousel-control" data-slide="next"><?php _e( 'Next', 'yatheme' ) ?></a>
								</div>
							</div>
							<?php }	?>							
						<?php } ?>
